...
public class EnemyHealth1 : MonoBehaviour
{
    ...
    private Enemy_behaviour_1 enemy_behaviour;
    ...
    private TriggerAreaCheck1 trigArea;
    //
    ...
    void Start()
    {
        ...
        enemy_behaviour = GetComponentInParent<Enemy_behaviour_1>();
        trigArea = trigCheck.GetComponent<TriggerAreaCheck1>();
    }
    ...
    bool WallDetection()
    {
        ...
        {
            return Physics2D.CircleCast(circlecollider2d.bounds.center, 0.1f, Vector2.left, 3f, wallsLayerMask).collider != null;
        }
        else if (rotation == 0f)    //facing right
        {
            return Physics2D.CircleCast(circlecollider2d.bounds.center, 0.1f, Vector2.right, 3f, wallsLayerMask).collider != null;
        }
